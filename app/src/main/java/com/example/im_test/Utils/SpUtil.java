...
public class SpUtil {
    ...
    private static SharedPreferences getSp(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences("ZhangMu_SP", Context.MODE_PRIVATE);
        }
        return sp;
    }
     ...
     */
    public static <T extends Serializable> void putObject(Context context,String key, Object obj) {
        try {
            put(context, key, obj);
        } catch (Exception e) {
            e.printStackTrace();
